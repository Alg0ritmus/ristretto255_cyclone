...
/**
  ...
  * which serves as the internal representation of field elements in GF(2^255-19).
  * In our code, 'field_elem' represents a list of eight words,
  * each with a length of 'uint32_t.' This structure is well-suited for our representation
  * of 'ristretto255' bcs. we do not need to perform packing/unpacking 
  * to obtain the internal representation required for internal calculations,
...
typedef uint32_t field_elem[FIELED_ELEM_SIZE];

...
/**
  ...
  * 
  * We decided to incorporate complex testing of our implementation,
  * where we test all ristretto255 functions. The test is performed
  * in multiple rounds. The number of rounds can be set in config.h.
...
// xxHash variables used in complex test
XXH32_state_t stateX;
XXH32_state_t *state = &stateX;
...
// Non-canonical field encodings.
    ...
    u8 test_negative_vectors_compl[8][BYTES_ELEM_SIZE] = {
        ...
        {0x0, 0xa8, 0x0, 0x27,0x36, 0xeb, 0x4, 0xdf,\
         0xeb, 0x8e, 0x2e, 0x3c,0x2d, 0xba, 0x31, 0xc3,\
         0x8b, 0x90, 0x34, 0x19,0xc5, 0xc9, 0x86, 0x2a,\
         0xe4, 0x95, 0xae, 0x91,0x41, 0x41, 0xf1, 0x5f},

        {0x2a, 0xb3, 0xb1, 0xe7,0xd9, 0x1a, 0x2b, 0xfc,\
         0x48, 0x71, 0xdb, 0x91,0x77, 0x55, 0xfa, 0xe3,\
         0xc9, 0x33, 0xf, 0x55,0x1, 0x40, 0x1, 0xec,\
         0x82, 0xeb, 0x75, 0xd4,0x6, 0xef, 0xba, 0x1d},

        {0x24, 0xbf, 0x1a, 0x5b,0xbf, 0xbe, 0xa8, 0x30,\
         0x4e, 0x9d, 0x74, 0xef,0x72, 0x4f, 0xae, 0x57,\
         0x2b, 0xc6, 0x1e, 0x5b,0xde, 0xc6, 0xb1, 0x3b,\
         0x14, 0x33, 0x46, 0x13,0x6d, 0x57, 0x53, 0x7},

        {0xa6, 0x30, 0x3a, 0xb6,0x83, 0xac, 0x23, 0x71,\
         0x9e, 0x36, 0xe2, 0xe8,0x2, 0x9d, 0x90, 0x4,\
         0xe3, 0xb6, 0x1d, 0x43,0x56, 0xb1, 0x12, 0xfa,\
         0xdd, 0x7e, 0x4a, 0xef,0x4e, 0xee, 0x85, 0x5b},

        {0xfc, 0x38, 0xe9, 0xa2,0xcc, 0xc9, 0x8c, 0xae,\
         0x4f, 0x25, 0x70, 0x91,0xba, 0xee, 0xfe, 0xf3,\
         0x97, 0xe8, 0xb5, 0xfc,0x49, 0xa7, 0xed, 0xed,\
         0x38, 0xe3, 0xf1, 0xe2,0xfd, 0x93, 0xc3, 0xd},

        {0x66, 0xd9, 0xf0, 0x85,0xd0, 0xed, 0xb6, 0xae,\
         0xe7, 0xc9, 0xf0, 0xfd,0x3d, 0x95, 0xb8, 0xf0,\
         0xba, 0xf2, 0x52, 0xc,0xb5, 0xbe, 0xc2, 0xde,\
         0xfb, 0xd4, 0xbc, 0x46,0x26, 0xc1, 0xec, 0x76},
    };

    u8 MAP_VECTORS[7][HASH_BYTES_SIZE]= {
        {0x5d, 0x1b, 0xe0, 0x9e, 0x3d, 0xc,  0x82, 0xfc,\
         0x53, 0x81, 0x12, 0x49, 0xe, 0x35, 0x70, 0x19,\
         0x79, 0xd9, 0x9e, 0x6, 0xca, 0x3e, 0x2b, 0x5b,\
         0x54, 0xbf, 0xfe, 0x8b, 0x4d, 0xc7, 0x72, 0xc1,\
         0x4d, 0x98, 0xb6, 0x96, 0xa1, 0xbb, 0xfb, 0x5c,\
         0xa3, 0x2c, 0x43, 0x6c, 0xc6, 0x1c, 0x16, 0x56,\
         0x37, 0x90, 0x30, 0x6c, 0x79, 0xea, 0xca, 0x77,\
         0x5, 0x66, 0x8b, 0x47, 0xdf, 0xfe, 0x5b, 0xb6},

        {0xf1, 0x16, 0xb3, 0x4b, 0x8f, 0x17, 0xce, 0xb5,\
         0x6e, 0x87, 0x32, 0xa6, 0xd, 0x91, 0x3d, 0xd1,\
          0xc, 0xce, 0x47, 0xa6, 0xd5, 0x3b, 0xee, 0x92,\
          0x4, 0xbe, 0x8b, 0x44, 0xf6, 0x67, 0x8b, 0x27,\
          0x1, 0x2, 0xa5, 0x69, 0x2, 0xe2, 0x48, 0x8c,\
          0x46, 0x12, 0xe, 0x92, 0x76, 0xcf, 0xe5, 0x46,\
          0x38, 0x28, 0x6b, 0x9e, 0x4b, 0x3c, 0xdb, 0x47,\
          0xb, 0x54, 0x2d, 0x46, 0xc2, 0x6, 0x8d, 0x38},

        {0x84, 0x22, 0xe1, 0xbb, 0xda, 0xab, 0x52, 0x93,\
         0x8b, 0x81, 0xfd, 0x60, 0x2e, 0xff, 0xb6, 0xf8,\
         0x91, 0x10, 0xe1, 0xe5, 0x72, 0x8, 0xad, 0x12,\
         0xd9, 0xad, 0x76, 0x7e, 0x2e, 0x25, 0x51, 0xc,\
         0x27, 0x14, 0x7, 0x75, 0xf9, 0x33, 0x70, 0x88,\
         0xb9, 0x82, 0xd8, 0x3d, 0x7f, 0xcf, 0xb, 0x2f,\
         0xa1, 0xed, 0xff, 0xe5, 0x19, 0x52, 0xcb, 0xe7,\
        0x36, 0x5e, 0x95, 0xc8, 0x6e, 0xaf, 0x32, 0x5c},

        {0xac, 0x22, 0x41, 0x51, 0x29, 0xb6, 0x14, 0x27,\
         0xbf, 0x46, 0x4e, 0x17, 0xba, 0xee, 0x8d, 0xb6,\
         0x59, 0x40, 0xc2, 0x33, 0xb9, 0x8a, 0xfc, 0xe8,\
         0xd1, 0x7c, 0x57, 0xbe, 0xeb, 0x78, 0x76, 0xc2,\
         0x15, 0xd, 0x15, 0xaf, 0x1c, 0xb1, 0xfb, 0x82,\
         0x4b, 0xbd, 0x14, 0x95, 0x5f, 0x2b, 0x57, 0xd0,\
         0x8d, 0x38, 0x8a, 0xab, 0x43, 0x1a, 0x39, 0x1c,\
         0xfc, 0x33, 0xd5, 0xba, 0xfb, 0x5d, 0xbb, 0xaf},

        {0x16, 0x5d, 0x69, 0x7a, 0x1e, 0xf3, 0xd5, 0xcf,\
         0x3c, 0x38, 0x56, 0x5b, 0xee, 0xfc, 0xf8, 0x8c,\
         0xf, 0x28, 0x2b, 0x8e, 0x7d, 0xbd, 0x28, 0x54,\
         0x4c, 0x48, 0x34, 0x32, 0xf1, 0xce, 0xc7, 0x67,\
         0x5d, 0xeb, 0xea, 0x8e, 0xbb, 0x4e, 0x5f, 0xe7,\
         0xd6, 0xf6, 0xe5, 0xdb, 0x15, 0xf1, 0x55, 0x87,\
         0xac, 0x4d, 0x4d, 0x4a, 0x1d, 0xe7, 0x19, 0x1e,\
         0xc, 0x1c, 0xa6, 0x66, 0x4a, 0xbc, 0xc4, 0x13},

        {0xa8, 0x36, 0xe6, 0xc9, 0xa9, 0xca, 0x9f, 0x1e,\
         0x8d, 0x48, 0x62, 0x73, 0xad, 0x56, 0xa7, 0x8c,\
         0x70, 0xcf, 0x18, 0xf0, 0xce, 0x10, 0xab, 0xb1,\
         0xc7, 0x17, 0x2d, 0xdd, 0x60, 0x5d, 0x7f, 0xd2,\
         0x97, 0x98, 0x54, 0xf4, 0x7a, 0xe1, 0xcc, 0xf2,\
         0x4, 0xa3, 0x31, 0x2, 0x9, 0x5b, 0x42, 0x0,\
         0xe5, 0xbe, 0xfc, 0x4, 0x65, 0xac, 0xcc, 0x26,\
         0x31, 0x75, 0x48, 0x5f, 0xe, 0x17, 0xea, 0x5c},

        {0x2c, 0xdc, 0x11, 0xea, 0xeb, 0x95, 0xda, 0xf0,\
         0x11, 0x89, 0x41, 0x7c, 0xdd, 0xdb, 0xf9, 0x59,\
         0x52, 0x99, 0x3a, 0xa9, 0xcb, 0x9c, 0x64, 0xe,\
         0xb5, 0x5, 0x8d, 0x9, 0x70, 0x2c, 0x74, 0x62,\
         0x2c, 0x99, 0x65, 0xa6, 0x97, 0xa3, 0xb3, 0x45,\
         0xec, 0x24, 0xee, 0x56, 0x33, 0x5b, 0x55, 0x6e,\
         0x67, 0x7b, 0x30, 0xe6, 0xf9, 0xa, 0xc7, 0x7d,\
    ...
    u8 MAP_VECTORS_RESULT[7][BYTES_ELEM_SIZE]= {
        {0x30, 0x66, 0xf8, 0x2a, 0x1a, 0x74, 0x7d, 0x45,\
         0x12, 0xd, 0x17, 0x40, 0xf1, 0x43, 0x58, 0x53,\
         0x1a, 0x8f, 0x4, 0xbb, 0xff, 0xe6, 0xa8, 0x19,\
         0xf8, 0x6d, 0xfe, 0x50, 0xf4, 0x4a, 0xa, 0x46},
...
///////////////////////////////////////////////////
//
//     ccccccc     pppppppp   lll        xx      xx
//    cc           pp    pp   lll          xx  xx
//    cc           pppppppp   lll            xx
//    cc           pp         lll          xx  xx
//     ccccccc     pp         lllllll    xx      xx
//

/*
 * Algorithm for complex testing of ristretto255:
 *
 * 0) set k=0; this variable is used at the end of test
 * 1) generate valid ristretto point P1
 *     // Note that COMPLEX_TEST_ITERATIONS can be set in config.h
 *     // Let COMPLEX_TEST_ITERATIONS be set to 1000; then the last 
 *     //point calculated will be P1000.
 * 2) forloop COMPLEX_TEST_ITERATIONS=1000 
 *      2.1) generate random SCALAR 
 *      2.2) calculate SCALAR^-1 (mod L)
 *      2.3) calc P2 = P1 * SCALAR
 *      2.4) check if P2 * SCALAR^-1 == P1
 *      2.5) k = k * SCALAR (mod L)
 *      2.6) P1 = P2 // and repeat COMPLEX_TEST_ITERATIONS times
 * 3) check if P1 == P1000 * k^-1 (mod L)
 *
 * Note that ristretto255 encoding and decoding
 ...
 */
    ...
    modl_l_inverse(SCALAR_INV,SCALAR_STORAGE); // P1e6 last check
